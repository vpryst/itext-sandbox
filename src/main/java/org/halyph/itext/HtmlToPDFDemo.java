        ...
        try {
            ...
            String str =
                "<html><head></head><body>" + "<a href='http://www.rgagnon.com/howto.html'><b>Real's HowTo</b></a>"
                    ...
                    + "<td style=\"background-color: blue\">background-color: blue<tr>"
                    + "<td style=\"background-color: #000000\">background-color: #000000<tr>"
                    + "<td style=\"background-color: #ff9900\">background-color: #ff9900<tr>"
